...
pub fn genesis_config() -> ChainSpec {
	...
	.with_boot_nodes(vec![
		...
		"/dns/g2.darwinia2.darwinia.network/tcp/30333/ws/p2p/12D3KooWQwmzsLSWh8D2HoPv4h6vJ1ue5YFkBjPTNnKZ1DM77yEW".parse().unwrap(),
	])
