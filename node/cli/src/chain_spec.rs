...
fn session_keys(babe: BabeId, im_online: ImOnlineId) -> SessionKeys {
	SessionKeys { babe, im_online }
}
...
fn staging_testnet_config_genesis() -> GenesisConfig {
	...
	// TODO: remove GrandpaId
	let initial_authorities: Vec<(AccountId, AccountId, BabeId, ImOnlineId)> = vec![
		(
			...
			// GrandpaId: 5Fb9ayurnxnaXj56CjmyQLBiadfRCqUbL2VWNbbe1nZU6wiC
		...
		(
			...
			// GrandpaId: 5E1jLYfLdUQKrFrtqoKgFrRvxM3oQPMbf6DfcsrugZZ5Bn8d
		...
		(
			...
			// GrandpaId: 5DMa31Hd5u1dwoRKgC4uvqyrdK45RHv3CpwvpUC1EzuwDit4
...
pub fn get_authority_keys_from_seed(seed: &str) -> (AccountId, AccountId, BabeId, ImOnlineId) {
	(
