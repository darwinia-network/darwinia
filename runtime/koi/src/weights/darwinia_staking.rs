...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(725_925_936, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 271_216
			.saturating_add(Weight::from_parts(13_863_338, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(780_003_150, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 271_982
			.saturating_add(Weight::from_parts(13_880_385, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	...
	fn payout() -> Weight {
		...
		Weight::from_parts(208_000_000, 0)
			.saturating_add(Weight::from_parts(0, 5310))
