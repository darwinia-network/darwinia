...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(653_462_438, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 242_063
			.saturating_add(Weight::from_parts(12_354_738, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(690_303_938, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 243_509
			.saturating_add(Weight::from_parts(12_382_062, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
	}
