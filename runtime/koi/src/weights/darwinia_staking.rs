...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(678_440_249, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 236_449
			.saturating_add(Weight::from_parts(11_970_473, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(666_940_010, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 236_445
			.saturating_add(Weight::from_parts(11_982_039, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
	}
