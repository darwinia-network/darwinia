...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(713_221_476, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 256_283
			.saturating_add(Weight::from_parts(12_886_306, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(754_642_664, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 263_617
			.saturating_add(Weight::from_parts(13_048_816, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	...
	fn payout() -> Weight {
		...
		//  Measured:  `2330`
		//  Estimated: `83902`
		// Minimum execution time: 534_000_000 picoseconds.
		Weight::from_parts(626_000_000, 0)
