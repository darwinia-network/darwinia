...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `4591`
		//  Estimated: `43510`
		// Minimum execution time: 144_475 nanoseconds.
		Weight::from_parts(144_475_000, 43510)
	...
	fn migrate_multisig(x: u32, y: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `4591`
		//  Estimated: `43510 + y * (7 ±0)`
		// Minimum execution time: 18_094 nanoseconds.
		Weight::from_parts(171_702_500, 43510)
			// Standard Error: 20_093
			.saturating_add(Weight::from_ref_time(70_116).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(10))
			.saturating_add(T::DbWeight::get().writes(14))
	...
	fn complete_multisig_migration() -> Weight {
		...
		//  Measured:  `4877`
		//  Estimated: `9943`
		// Minimum execution time: 20_376 nanoseconds.
		Weight::from_parts(20_376_000, 9943)
