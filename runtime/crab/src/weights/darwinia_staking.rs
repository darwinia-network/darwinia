...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(673_923_539, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 255_028
			.saturating_add(Weight::from_parts(13_024_071, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(691_873_667, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 257_398
			.saturating_add(Weight::from_parts(13_012_274, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
	}
