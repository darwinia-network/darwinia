...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(158_171_173, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_736
			.saturating_add(Weight::from_parts(10_138, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(68_981_598, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_214
			.saturating_add(Weight::from_parts(8_153, 0).saturating_mul(x.into()))
	...
	fn restake(x: u32, ) -> Weight {
		...
		Weight::from_parts(58_939_316, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_015
			.saturating_add(Weight::from_parts(5_660, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `DarwiniaStaking::Ledgers` (r:1 w:1)
	...
	fn payout() -> Weight {
		...
		Weight::from_parts(183_000_000, 0)
			.saturating_add(Weight::from_parts(0, 4880))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(2))
	}
