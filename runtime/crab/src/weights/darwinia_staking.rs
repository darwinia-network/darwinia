...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(125_223_039, 0)
			.saturating_add(Weight::from_parts(0, 51255))
			// Standard Error: 1_691
			.saturating_add(Weight::from_parts(9_797, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(55_093_599, 0)
			.saturating_add(Weight::from_parts(0, 37915))
			// Standard Error: 979
			.saturating_add(Weight::from_parts(5_809, 0).saturating_mul(x.into()))
	...
	fn restake(x: u32, ) -> Weight {
		...
		Weight::from_parts(46_302_487, 0)
			.saturating_add(Weight::from_parts(0, 37915))
			// Standard Error: 815
			.saturating_add(Weight::from_parts(4_660, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: DarwiniaStaking Ledgers (r:1 w:1)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(95_371_000, 0)
