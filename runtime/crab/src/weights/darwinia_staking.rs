...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(_x: u32, ) -> Weight {
		...
		//  Measured:  `2646 + x * (4 ±0)`
		//  Estimated: `18035`
		// Minimum execution time: 88_269 nanoseconds.
		Weight::from_parts(151_957_000, 18035)
	...
	fn unstake(_x: u32, ) -> Weight {
		...
		Weight::from_parts(83_287_000, 7665)
	...
	fn restake(_x: u32, ) -> Weight {
		...
		//  Measured:  `1292 + x * (4 ±0)`
		//  Estimated: `7665`
		// Minimum execution time: 27_644 nanoseconds.
		Weight::from_parts(67_479_000, 7665)
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: DarwiniaStaking Ledgers (r:1 w:1)
	...
	fn claim() -> Weight {
		...
		//  Measured:  `4010`
		//  Estimated: `17013`
		// Minimum execution time: 120_875 nanoseconds.
		Weight::from_parts(120_875_000, 17013)
	...
	fn collect() -> Weight {
		...
		Weight::from_parts(21_914_000, 2507)
	...
	fn nominate() -> Weight {
		...
		//  Measured:  `1409`
		//  Estimated: `8345`
		// Minimum execution time: 22_326 nanoseconds.
		Weight::from_parts(22_326_000, 8345)
