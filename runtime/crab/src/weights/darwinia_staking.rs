...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(685_264_990, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 276_267
			.saturating_add(Weight::from_parts(14_127_904, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(753_638_178, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 276_450
			.saturating_add(Weight::from_parts(14_122_363, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
	}
