...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(176_329_502, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_844
			.saturating_add(Weight::from_parts(10_145, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(77_435_711, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_362
			.saturating_add(Weight::from_parts(7_010, 0).saturating_mul(x.into()))
	...
	fn restake(x: u32, ) -> Weight {
		...
		Weight::from_parts(65_347_136, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_117
			.saturating_add(Weight::from_parts(6_804, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `DarwiniaStaking::Ledgers` (r:1 w:1)
