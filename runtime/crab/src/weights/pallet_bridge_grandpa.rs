...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn submit_finality_proof(p: u32, _v: u32, ) -> Weight {
		...
		//  Estimated: `165335`
		// Minimum execution time: 1_705_000_000 picoseconds.
		Weight::from_parts(1_750_000_000, 0)
			.saturating_add(Weight::from_parts(0, 165335))
			// Standard Error: 170_189
			.saturating_add(Weight::from_parts(21_593_346, 0).saturating_mul(p.into()))
