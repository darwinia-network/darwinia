...
const TRACKS_DATA: [(u16, pallet_referenda::TrackInfo<Balance, BlockNumber>); 7] = [
	...
	(
		...
		pallet_referenda::TrackInfo {
			...
			confirm_period: DAYS,
			min_enactment_period: DAYS,
			min_approval: pallet_referenda::Curve::make_linear(11, 14, percent(50), percent(100)),
			min_support: pallet_referenda::Curve::make_reciprocal(8, 14, percent(1), percent(0), percent(50)),
		},
	),
	(
		6,
		pallet_referenda::TrackInfo {
			...
			min_enactment_period: DAYS,
			min_approval: pallet_referenda::Curve::make_linear(14, 14, percent(50), percent(100)),
			min_support: pallet_referenda::Curve::make_reciprocal(10, 14, percent(1), percent(0), percent(50)),
		},
	),
];
