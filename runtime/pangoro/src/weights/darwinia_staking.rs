...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(183_571_833, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_975
			.saturating_add(Weight::from_parts(11_025, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(81_554_306, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_461
			.saturating_add(Weight::from_parts(6_782, 0).saturating_mul(x.into()))
	...
	fn restake(x: u32, ) -> Weight {
		...
		Weight::from_parts(68_755_372, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_185
			.saturating_add(Weight::from_parts(5_879, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `DarwiniaStaking::Ledgers` (r:1 w:1)
