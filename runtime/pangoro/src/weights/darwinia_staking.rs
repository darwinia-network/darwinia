...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(158_839_574, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_759
			.saturating_add(Weight::from_parts(9_644, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(68_831_139, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_205
			.saturating_add(Weight::from_parts(6_760, 0).saturating_mul(x.into()))
	...
	fn restake(x: u32, ) -> Weight {
		...
		Weight::from_parts(58_642_554, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_024
			.saturating_add(Weight::from_parts(5_599, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `DarwiniaStaking::Ledgers` (r:1 w:1)
