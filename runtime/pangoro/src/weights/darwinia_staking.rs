...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(123_707_108, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_374
			.saturating_add(Weight::from_parts(5_101, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(51_477_805, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 909
			.saturating_add(Weight::from_parts(4_083, 0).saturating_mul(x.into()))
	...
	fn restake(x: u32, ) -> Weight {
		...
		Weight::from_parts(43_058_183, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 772
			.saturating_add(Weight::from_parts(4_444, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `DarwiniaStaking::Ledgers` (r:1 w:1)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(92_129_000, 0)
			.saturating_add(Weight::from_parts(0, 29615))
