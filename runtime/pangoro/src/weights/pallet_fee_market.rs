...
impl<T: frame_system::Config> pallet_fee_market::WeightInfo for WeightInfo<T> {
	...
	/// Proof: `PangolinFeeMarket::Relayers` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	/// Proof: `PangolinFeeMarket::RelayersMap` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `PangolinFeeMarket::Orders` (r:1 w:0)
	/// Proof: `PangolinFeeMarket::Orders` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `PangolinFeeMarket::AssignedRelayersNumber` (r:1 w:0)
	/// Proof: `PangolinFeeMarket::AssignedRelayersNumber` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: `PangolinFeeMarket::AssignedRelayers` (r:0 w:1)
	/// Proof: `PangolinFeeMarket::AssignedRelayers` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn enroll_and_lock_collateral() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1649`
		//  Estimated: `27389`
		// Minimum execution time: 89_316_000 picoseconds.
		Weight::from_parts(91_934_000, 0)
	...
	fn increase_locked_collateral() -> Weight {
		...
		//  Measured:  `1721`
		//  Estimated: `27461`
		// Minimum execution time: 85_226_000 picoseconds.
		Weight::from_parts(87_279_000, 0)
	...
	fn decrease_locked_collateral() -> Weight {
		...
		//  Measured:  `1721`
		//  Estimated: `27461`
		// Minimum execution time: 102_947_000 picoseconds.
		Weight::from_parts(105_707_000, 0)
			.saturating_add(Weight::from_parts(0, 27461))
			.saturating_add(T::DbWeight::get().reads(16))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	...
	fn update_relay_fee() -> Weight {
		...
		Weight::from_parts(69_474_000, 0)
	...
	fn cancel_enrollment() -> Weight {
		...
		//  Measured:  `1788`
		//  Estimated: `25053`
		// Minimum execution time: 87_679_000 picoseconds.
		Weight::from_parts(91_378_000, 0)
			.saturating_add(Weight::from_parts(0, 25053))
			.saturating_add(T::DbWeight::get().reads(16))
			.saturating_add(T::DbWeight::get().writes(5))
	}
	/// Storage: `PangolinFeeMarket::CollateralSlashProtect` (r:0 w:1)
	/// Proof: `PangolinFeeMarket::CollateralSlashProtect` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn set_assigned_relayers_number() -> Weight {
		...
		Weight::from_parts(66_484_000, 0)
			.saturating_add(Weight::from_parts(0, 27042))
