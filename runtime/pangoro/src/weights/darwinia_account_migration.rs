...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `29142`
		//  Estimated: `32607`
		// Minimum execution time: 140_621_000 picoseconds.
	...
	fn migrate_multisig(x: u32, _y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(20_915_867, 0)
			.saturating_add(Weight::from_parts(0, 2))
			// Standard Error: 12_059
			.saturating_add(Weight::from_parts(8_968, 0).saturating_mul(x.into()))
