...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `29142`
		//  Estimated: `32607`
		// Minimum execution time: 146_615_000 picoseconds.
		Weight::from_parts(149_125_000, 0)
	...
	fn migrate_multisig(x: u32, _y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(22_268_275, 0)
			.saturating_add(Weight::from_parts(0, 2))
			// Standard Error: 13_016
			.saturating_add(Weight::from_parts(7_507, 0).saturating_mul(x.into()))
