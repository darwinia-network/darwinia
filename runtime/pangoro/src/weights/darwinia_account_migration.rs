...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `4594`
		//  Estimated: `43516`
		// Minimum execution time: 181_715 nanoseconds.
		Weight::from_parts(181_715_000, 43516)
	...
	fn migrate_multisig(x: u32, y: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `4594`
		//  Estimated: `43516 + y * (7 ±0)`
		// Minimum execution time: 13_194 nanoseconds.
		Weight::from_parts(221_352_500, 43516)
			// Standard Error: 24_309
			.saturating_add(Weight::from_ref_time(48_772).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(10))
			.saturating_add(T::DbWeight::get().writes(14))
	...
	fn complete_multisig_migration() -> Weight {
		...
		Weight::from_parts(21_350_000, 9946)
