...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `5629`
		//  Estimated: `51939`
		// Minimum execution time: 258_968 nanoseconds.
		Weight::from_parts(258_968_000, 51939)
	...
	fn migrate_multisig(x: u32, y: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `5629`
		//  Estimated: `51939 + y * (7 ±0)`
		// Minimum execution time: 13_552 nanoseconds.
		Weight::from_parts(237_578_500, 51939)
			// Standard Error: 638_803
			.saturating_add(Weight::from_ref_time(413_752).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(12))
			.saturating_add(T::DbWeight::get().writes(18))
	...
	fn complete_multisig_migration() -> Weight {
		...
		//  Measured:  `4880`
		//  Estimated: `9946`
		// Minimum execution time: 36_876 nanoseconds.
		Weight::from_parts(36_876_000, 9946)
