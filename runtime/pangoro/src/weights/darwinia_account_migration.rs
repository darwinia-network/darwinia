...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `30224`
		//  Estimated: `113012`
		// Minimum execution time: 142_632_000 picoseconds.
		Weight::from_parts(146_828_000, 0)
	...
	fn migrate_multisig(x: u32, _y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(23_855_910, 0)
			.saturating_add(Weight::from_parts(0, 5))
			// Standard Error: 12_598
			.saturating_add(Weight::from_parts(9_347, 0).saturating_mul(x.into()))
