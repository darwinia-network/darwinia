...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn set_asset_units_per_second(x: u32, ) -> Weight {
		...
		Weight::from_parts(16_810_363, 0)
			.saturating_add(Weight::from_parts(0, 3983))
			// Standard Error: 2_082
			.saturating_add(Weight::from_parts(329_481, 0).saturating_mul(x.into()))
	...
	fn change_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(25_440_012, 0)
			.saturating_add(Weight::from_parts(0, 4303))
			// Standard Error: 3_740
			.saturating_add(Weight::from_parts(336_831, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(3))
	...
	fn remove_supported_asset(x: u32, ) -> Weight {
		...
		Weight::from_parts(9_832_398, 0)
			.saturating_add(Weight::from_parts(0, 1678))
			// Standard Error: 1_647
			.saturating_add(Weight::from_parts(290_226, 0).saturating_mul(x.into()))
	...
	fn remove_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(17_425_346, 0)
			.saturating_add(Weight::from_parts(0, 3949))
			// Standard Error: 4_402
			.saturating_add(Weight::from_parts(311_738, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(4))
			.saturating_add(Weight::from_parts(0, 10).saturating_mul(x.into()))
	}
