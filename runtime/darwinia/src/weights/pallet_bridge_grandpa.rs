...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	/// Proof: `BridgeKusamaGrandpa::RequestCount` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	...
	/// Proof: `BridgeKusamaGrandpa::CurrentAuthoritySet` (`max_values`: Some(1), `max_size`: Some(163850), added: 164345, mode: `MaxEncodedLen`)
	...
	/// Proof: `BridgeKusamaGrandpa::ImportedHashes` (`max_values`: None, `max_size`: Some(36), added: 2511, mode: `MaxEncodedLen`)
	...
	fn submit_finality_proof(p: u32, v: u32, ) -> Weight {
		...
		//  Estimated: `165335`
		// Minimum execution time: 1_735_000_000 picoseconds.
		Weight::from_parts(143_312_610, 0)
			.saturating_add(Weight::from_parts(0, 165335))
			// Standard Error: 55_241
			.saturating_add(Weight::from_parts(29_788_390, 0).saturating_mul(p.into()))
			// Standard Error: 56_552
			.saturating_add(Weight::from_parts(1_568_344, 0).saturating_mul(v.into()))
