...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	/// Proof: BridgeKusamaGrandpa CurrentAuthoritySet (max_values: Some(1), max_size: Some(4000012), added: 4000507, mode: MaxEncodedLen)
	...
	fn submit_finality_proof(p: u32, _v: u32, ) -> Weight {
		...
		//  Estimated: `4145552`
		// Minimum execution time: 1_697_566_000 picoseconds.
		Weight::from_parts(1_697_566_000, 0)
			.saturating_add(Weight::from_parts(0, 4145552))
			// Standard Error: 4_884_906
			.saturating_add(Weight::from_parts(19_090_458, 0).saturating_mul(p.into()))
