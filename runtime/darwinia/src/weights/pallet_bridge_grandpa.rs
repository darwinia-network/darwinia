...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn submit_finality_proof(p: u32, _v: u32, ) -> Weight {
		...
		//  Estimated: `309390`
		// Minimum execution time: 1_631_919_000 picoseconds.
		Weight::from_parts(1_645_635_000, 0)
			.saturating_add(Weight::from_parts(0, 309390))
			// Standard Error: 151_839
			.saturating_add(Weight::from_parts(20_149_687, 0).saturating_mul(p.into()))
