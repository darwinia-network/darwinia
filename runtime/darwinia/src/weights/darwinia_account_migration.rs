...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		Weight::from_parts(180_000_000, 0)
			.saturating_add(Weight::from_parts(0, 32313))
	...
	fn migrate_multisig(x: u32, _y: u32, z: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		//  Estimated: `2 + x * (163 ±0) + z * (163 ±0)`
		// Minimum execution time: 8_000_000 picoseconds.
		Weight::from_parts(27_413_696, 0)
			.saturating_add(Weight::from_parts(0, 2))
			// Standard Error: 15_863
			.saturating_add(Weight::from_parts(16_257, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(Weight::from_parts(0, 163).saturating_mul(x.into()))
			.saturating_add(Weight::from_parts(0, 163).saturating_mul(z.into()))
	}
