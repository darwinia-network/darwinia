...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `30224`
		//  Estimated: `113012`
		// Minimum execution time: 147_672_000 picoseconds.
		Weight::from_parts(155_025_000, 0)
	...
	fn migrate_multisig(x: u32, _y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(25_012_372, 0)
			.saturating_add(Weight::from_parts(0, 5))
			// Standard Error: 13_446
			.saturating_add(Weight::from_parts(11_940, 0).saturating_mul(x.into()))
