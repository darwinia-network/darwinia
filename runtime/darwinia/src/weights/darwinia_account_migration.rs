...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `4595`
		//  Estimated: `43518`
		// Minimum execution time: 161_086 nanoseconds.
		Weight::from_parts(161_086_000, 43518)
	...
	fn migrate_multisig(x: u32, y: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `4595`
		//  Estimated: `43518 + y * (7 ±0)`
		// Minimum execution time: 22_235 nanoseconds.
		Weight::from_parts(141_041_000, 43518)
			// Standard Error: 323_578
			.saturating_add(Weight::from_ref_time(215_262).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(10))
			.saturating_add(T::DbWeight::get().writes(14))
	...
	fn complete_multisig_migration() -> Weight {
		...
		Weight::from_parts(20_968_000, 9947)
