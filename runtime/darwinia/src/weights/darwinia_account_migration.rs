...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `5668`
		//  Estimated: `52017`
		// Minimum execution time: 210_142 nanoseconds.
		Weight::from_parts(210_142_000, 52017)
	...
	fn migrate_multisig(x: u32, y: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `5668`
		//  Estimated: `52017 + y * (7 ±0)`
		// Minimum execution time: 27_933 nanoseconds.
		Weight::from_parts(254_670_500, 52017)
			// Standard Error: 247_744
			.saturating_add(Weight::from_ref_time(51_772).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(12))
			.saturating_add(T::DbWeight::get().writes(18))
	...
	fn complete_multisig_migration() -> Weight {
		...
		Weight::from_parts(22_770_000, 9947)
