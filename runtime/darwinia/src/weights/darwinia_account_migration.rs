...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate_multisig(x: u32, _y: u32, z: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		//  Estimated: `0 + x * (18 ±0) + z * (18 ±0)`
		// Minimum execution time: 6_000_000 picoseconds.
		Weight::from_parts(10_220_315, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 2_252
			.saturating_add(Weight::from_parts(41_724, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().writes(1))
			.saturating_add(Weight::from_parts(0, 18).saturating_mul(x.into()))
			.saturating_add(Weight::from_parts(0, 18).saturating_mul(z.into()))
	}
