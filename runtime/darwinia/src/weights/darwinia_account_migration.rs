...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		Weight::from_parts(120_000_000, 0)
			.saturating_add(Weight::from_parts(0, 31899))
	...
	fn migrate_multisig(x: u32, _y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(19_533_534, 0)
			.saturating_add(Weight::from_parts(0, 2))
			// Standard Error: 10_492
			.saturating_add(Weight::from_parts(14_924, 0).saturating_mul(x.into()))
