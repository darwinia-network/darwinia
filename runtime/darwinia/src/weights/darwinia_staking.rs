...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(770_181_918, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 262_777
			.saturating_add(Weight::from_parts(13_019_225, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(755_853_947, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 261_936
			.saturating_add(Weight::from_parts(13_061_272, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	...
	fn payout() -> Weight {
		...
		Weight::from_parts(616_000_000, 0)
