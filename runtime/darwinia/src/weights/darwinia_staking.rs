...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(885_880_268, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 282_311
			.saturating_add(Weight::from_parts(13_641_040, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(728_420_174, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 275_834
			.saturating_add(Weight::from_parts(13_851_087, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	...
	fn payout() -> Weight {
		...
		//  Measured:  `2184`
		//  Estimated: `83902`
		// Minimum execution time: 665_000_000 picoseconds.
		Weight::from_parts(748_000_000, 0)
