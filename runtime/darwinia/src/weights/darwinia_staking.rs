...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(_x: u32, ) -> Weight {
		...
		Weight::from_parts(126_792_450, 0)
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(52_220_320, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 904
			.saturating_add(Weight::from_parts(4_941, 0).saturating_mul(x.into()))
	...
	fn restake(x: u32, ) -> Weight {
		...
		Weight::from_parts(44_128_216, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 757
			.saturating_add(Weight::from_parts(4_318, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `DarwiniaStaking::Ledgers` (r:1 w:1)
	...
	fn claim() -> Weight {
		...
		//  Measured:  `2078`
		//  Estimated: `29615`
		// Minimum execution time: 90_017_000 picoseconds.
	...
	fn payout() -> Weight {
		...
		//  Measured:  `1611`
		//  Estimated: `83902`
		// Minimum execution time: 161_790_000 picoseconds.
		Weight::from_parts(164_218_000, 0)
