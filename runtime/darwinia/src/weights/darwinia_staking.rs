...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(158_532_492, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_618
			.saturating_add(Weight::from_parts(7_889, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(69_062_763, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_215
			.saturating_add(Weight::from_parts(7_113, 0).saturating_mul(x.into()))
	...
	fn restake(x: u32, ) -> Weight {
		...
		Weight::from_parts(58_166_866, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_004
			.saturating_add(Weight::from_parts(5_700, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `DarwiniaStaking::Ledgers` (r:1 w:1)
