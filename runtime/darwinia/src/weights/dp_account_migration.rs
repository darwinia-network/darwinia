...
//! Autogenerated weights for `dp_account_migration`
//!
...
/// Weight functions for `dp_account_migration`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> dp_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		Weight::from_parts(170_000_000, 0)
			.saturating_add(Weight::from_parts(0, 32676))
	...
	fn migrate_multisig(x: u32, _y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(24_031_135, 0)
			.saturating_add(Weight::from_parts(0, 2))
			// Standard Error: 14_438
			.saturating_add(Weight::from_parts(11_415, 0).saturating_mul(x.into()))
