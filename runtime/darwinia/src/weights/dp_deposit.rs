...
//! Autogenerated weights for `dp_deposit`
//!
...
/// Weight functions for `dp_deposit`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> dp_deposit::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		//  Measured:  `26578`
		//  Estimated: `29615`
		// Minimum execution time: 1_585_000_000 picoseconds.
		Weight::from_parts(1_599_000_000, 0)
			.saturating_add(Weight::from_parts(0, 29615))
