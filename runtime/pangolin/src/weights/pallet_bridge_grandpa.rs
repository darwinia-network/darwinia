...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn submit_finality_proof(p: u32, _v: u32, ) -> Weight {
		...
		//  Estimated: `165335`
		// Minimum execution time: 1_790_557_000 picoseconds.
		Weight::from_parts(2_881_401_060, 0)
			.saturating_add(Weight::from_parts(0, 165335))
			// Standard Error: 1_400_764
			.saturating_add(Weight::from_parts(5_962_540, 0).saturating_mul(p.into()))
