...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn submit_finality_proof(p: u32, _v: u32, ) -> Weight {
		...
		//  Measured:  `2577 + p * (40 ±0)`
		//  Estimated: `243854`
		// Minimum execution time: 1_570_483_000 picoseconds.
		Weight::from_parts(1_592_242_000, 0)
			.saturating_add(Weight::from_parts(0, 243854))
			// Standard Error: 158_449
			.saturating_add(Weight::from_parts(20_925_984, 0).saturating_mul(p.into()))
