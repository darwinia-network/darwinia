...
impl<T: frame_system::Config> darwinia_deposit::WeightInfo for WeightInfo<T> {
	...
	fn lock() -> Weight {
		...
		//  Measured:  `26848`
		//  Estimated: `29615`
		// Minimum execution time: 69_455_000 picoseconds.
		Weight::from_parts(74_444_000, 0)
	...
	fn claim() -> Weight {
		...
		//  Measured:  `26578`
		//  Estimated: `29615`
		// Minimum execution time: 1_210_156_000 picoseconds.
		Weight::from_parts(1_235_398_000, 0)
			.saturating_add(Weight::from_parts(0, 29615))
	...
	fn claim_with_penalty() -> Weight {
		...
		Weight::from_parts(50_394_000, 0)
			.saturating_add(Weight::from_parts(0, 29615))
