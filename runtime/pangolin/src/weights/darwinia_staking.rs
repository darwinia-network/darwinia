...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(156_297_839, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_666
			.saturating_add(Weight::from_parts(5_049, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(66_739_405, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_167
			.saturating_add(Weight::from_parts(6_506, 0).saturating_mul(x.into()))
	...
	fn restake(x: u32, ) -> Weight {
		...
		Weight::from_parts(58_989_639, 0)
			.saturating_add(Weight::from_parts(0, 29615))
			// Standard Error: 1_147
			.saturating_add(Weight::from_parts(4_521, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `DarwiniaStaking::Ledgers` (r:1 w:1)
