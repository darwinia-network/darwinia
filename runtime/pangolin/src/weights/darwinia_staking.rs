...
impl<T: frame_system::Config> darwinia_staking::WeightInfo for WeightInfo<T> {
	...
	fn stake(x: u32, ) -> Weight {
		...
		Weight::from_parts(123_335_298, 0)
			.saturating_add(Weight::from_parts(0, 51255))
			// Standard Error: 1_610
			.saturating_add(Weight::from_parts(8_651, 0).saturating_mul(x.into()))
	...
	fn unstake(x: u32, ) -> Weight {
		...
		Weight::from_parts(54_360_457, 0)
			.saturating_add(Weight::from_parts(0, 37915))
			// Standard Error: 957
			.saturating_add(Weight::from_parts(5_396, 0).saturating_mul(x.into()))
	...
	fn restake(x: u32, ) -> Weight {
		...
		Weight::from_parts(45_909_512, 0)
			.saturating_add(Weight::from_parts(0, 37915))
			// Standard Error: 784
			.saturating_add(Weight::from_parts(4_161, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: DarwiniaStaking Ledgers (r:1 w:1)
	...
	fn claim() -> Weight {
		...
		//  Measured:  `2160`
		//  Estimated: `48253`
		// Minimum execution time: 90_587_000 picoseconds.
		Weight::from_parts(93_154_000, 0)
