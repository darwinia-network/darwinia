...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `5667`
		//  Estimated: `52015`
		// Minimum execution time: 168_993 nanoseconds.
		Weight::from_parts(168_993_000, 52015)
	...
	fn migrate_multisig(x: u32, y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(222_440_000, 52015)
			// Standard Error: 25_723
			.saturating_add(Weight::from_ref_time(103_141).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(12))
			.saturating_add(T::DbWeight::get().writes(18))
	...
	fn complete_multisig_migration() -> Weight {
		...
		Weight::from_parts(21_747_000, 9914)
