...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `29212`
		//  Estimated: `32677`
		// Minimum execution time: 142_393_000 picoseconds.
		Weight::from_parts(143_980_000, 0)
	...
	fn migrate_multisig(x: u32, _y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(21_950_453, 0)
			.saturating_add(Weight::from_parts(0, 2))
			// Standard Error: 12_614
			.saturating_add(Weight::from_parts(6_785, 0).saturating_mul(x.into()))
