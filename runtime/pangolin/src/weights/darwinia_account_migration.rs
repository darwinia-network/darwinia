...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `5667`
		//  Estimated: `52015`
		// Minimum execution time: 152_085 nanoseconds.
		Weight::from_parts(152_085_000, 52015)
	...
	fn migrate_multisig(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(190_326_500, 52015)
			// Standard Error: 33_162
			.saturating_add(Weight::from_ref_time(85_368).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(12))
			.saturating_add(T::DbWeight::get().writes(18))
	...
	fn complete_multisig_migration() -> Weight {
		...
		//  Measured:  `4848`
		//  Estimated: `9914`
		// Minimum execution time: 20_708 nanoseconds.
		Weight::from_parts(20_708_000, 9914)
