...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `4599`
		//  Estimated: `43526`
		// Minimum execution time: 130_080 nanoseconds.
		Weight::from_parts(130_080_000, 43526)
	...
	fn migrate_multisig(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(146_207_000, 43526)
			// Standard Error: 59_572
			.saturating_add(Weight::from_ref_time(140_444).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(10))
			.saturating_add(T::DbWeight::get().writes(14))
	...
	fn complete_multisig_migration() -> Weight {
		...
		Weight::from_parts(19_253_000, 9914)
