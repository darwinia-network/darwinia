...
impl<T: frame_system::Config> darwinia_account_migration::WeightInfo for WeightInfo<T> {
	...
	fn migrate() -> Weight {
		...
		//  Measured:  `30261`
		//  Estimated: `113086`
		// Minimum execution time: 140_503_000 picoseconds.
		Weight::from_parts(149_101_000, 0)
	...
	fn migrate_multisig(x: u32, _y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(22_620_997, 0)
			.saturating_add(Weight::from_parts(0, 5))
			// Standard Error: 12_433
			.saturating_add(Weight::from_parts(17_548, 0).saturating_mul(x.into()))
	...
	fn complete_multisig_migration() -> Weight {
		...
		Weight::from_parts(10_181_000, 0)
