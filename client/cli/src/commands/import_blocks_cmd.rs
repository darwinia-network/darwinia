...
use sc_service::{ChainSpec, ChainSpecExtension, Configuration, Roles, RuntimeGenesis, ServiceBuilderCommand};
...
impl ImportBlocksCmd {
		...
		<BB as BlockT>::Hash: std::str::FromStr,
	{
		...
		run_until_exit(config, |config| Ok(builder(config)?.import_blocks(file, false)))
	}
		...
		F: FnOnce(&str) -> Result<Option<ChainSpec<G, E>>, String>,
	{
		...
		self.import_params
			.update_config(&mut config, Roles::FULL, self.shared_params.dev)?;
