...
/// SIGTERM or SIGINT
pub fn run_until_exit<FUT, ERR, G, E, F>(mut config: Configuration<G, E>, future_builder: F) -> error::Result<()>
where
...
pub fn run_service_until_exit<T, G, E, F>(mut config: Configuration<G, E>, service_builder: F) -> error::Result<()>
where
