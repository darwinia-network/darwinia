	...
	RP: StructOpt + StructOptInternal,
{
	fn clap<'a, 'b>() -> App<'a, 'b> {
		...
		.subcommand(
			CheckBlockCmd::augment_clap(SubCommand::with_name("check-block")).about("Re-validate a known block."),
		)
		.subcommand(
	...
	fn from_clap(matches: &::structopt::clap::ArgMatches) -> Self {
		match matches.subcommand() {
			...
			("check-block", Some(matches)) => CoreParams::CheckBlock(CheckBlockCmd::from_clap(matches)),
...
#[serde(rename_all = "kebab-case")]
pub struct Conf {
	pub shared_params: Option<SharedParams>,
	...
	pub unsafe_rpc_external: Option<bool>,
	pub ws_external: Option<bool>,
	pub unsafe_ws_external: Option<bool>,
	pub grafana_external: Option<bool>,
	pub rpc_port: Option<u16>,
	pub ws_port: Option<u16>,
	pub grafana_port: Option<u16>,
	pub ws_max_connections: Option<usize>,
	...
	pub tracing_targets: Option<String>,
	pub tracing_receiver: Option<TracingReceiver>,
