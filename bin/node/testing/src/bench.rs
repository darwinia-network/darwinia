...
use node_runtime::{
	constants::currency::DOLLARS, AccountId, BalancesCall, Call, CheckedExtrinsic, MinimumPeriod, Signature,
	UncheckedExtrinsic,
};
use sc_client_api::{
...
impl BenchKeyring {
	...
	pub fn generate_genesis(&self) -> node_runtime::GenesisConfig {
		crate::genesis::config_endowed(false, Some(node_runtime::WASM_BINARY), self.collect_account_ids())
	}
}
