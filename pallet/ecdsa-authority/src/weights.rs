...
//! Autogenerated weights for dp_ecdsa_authority
//!
...
/// Weight functions needed for dp_ecdsa_authority.
...
/// Weights for dp_ecdsa_authority using the Substrate node and recommended hardware.
