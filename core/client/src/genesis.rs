...
use sr_primitives::traits::{Block as BlockT, Hash as HashT, Header as HeaderT, Zero};
...
mod tests {
	...
	use state_machine::{ExecutionStrategy, InMemoryChangesTrieStorage, OverlayedChanges, StateMachine};
	use test_client::{
