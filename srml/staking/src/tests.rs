...
//	ExtBuilder::default().existential_deposit(0).build().execute_with(|| {
//		TimestampM::set_timestamp(13 * MONTH_IN_SECONDS as u64);
//
...
//		TimestampM::set_timestamp(promise_month * MONTH_IN_SECONDS as u64);
//		assert_ok!(Staking::unbond(
//			Origin::signed(controller_2),
...
//		}
//
//		TimestampM::set_timestamp(promise_month as u64 * MONTH_IN_SECONDS as u64);
//
//		for _ in 1..deposit_items_len {
...
//		}
//
//		TimestampM::set_timestamp(expiry_date - 1);
...
//		);
//
//		TimestampM::set_timestamp(expiry_date);
//		assert_ok!(Staking::promise_extra(
//			Origin::signed(controller),
//			2 * COIN,
//			promise_month
...
#[test]
fn xavier_q1_tmp_test_for_auto_withdraw_kton() {
	ExtBuilder::default().existential_deposit(0).build().execute_with(|| {
		let stash = 777;
		let controller = 888;
		...
		assert_err!(
			Kton::transfer(Origin::signed(stash), controller, 10),
