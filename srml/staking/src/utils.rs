/// utility in staking
use crate::{ErasNums, KtonBalanceOf, Module, RingBalanceOf, Trait};
...
pub fn compute_current_era_reward<T: Trait + 'static>() -> RingBalanceOf<T> {
    ...
    let total_left: u128 = (T::Cap::get() - T::Ring::total_issuance())
        .try_into()
        .unwrap_or_default() as u128;
    let surplus = U256::from(total_left)
        - U256::from(total_left * 99 * current_epoch.integer_sqrt() as u128)
            / U256::from(current_epoch.integer_sqrt() as u128 * 100);
